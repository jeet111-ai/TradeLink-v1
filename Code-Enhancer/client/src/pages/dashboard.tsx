...
export default function Dashboard() {
  ...
  const winRate = (() => {
    ...
    const wins = closed.filter(t => Number(t.sellPrice) > Number(t.buyPrice)).length;
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button onClick={handleNewTrade} className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/20">
        ...
        <div className="space-y-6">
          <Card className="glass-card border-border/50">
            ...
            <CardContent className="space-y-4">
               <div className="p-3 rounded-lg bg-muted/30 border border-border">
                  <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Best Day</p>
                  <p className="text-lg font-bold text-profit mt-1">₹12,450.00</p>
               </div>
               <div className="p-3 rounded-lg bg-muted/30 border border-border">
                  <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Worst Day</p>
                  <p className="text-lg font-bold text-loss mt-1">-₹4,200.00</p>
               </div>
               <div className="p-3 rounded-lg bg-muted/30 border border-border">
                  <p className="text-xs text-muted-foreground uppercase tracking-wider font-semibold">Avg Daily P&L</p>
          ...
          <Card className="glass-card border-border/50 overflow-hidden">
            <CardHeader className="flex flex-row items-center gap-2 space-y-0 pb-2 px-4 py-3 border-b border-border/50">
              ...
              <CardTitle className="text-sm font-medium uppercase tracking-wider">Market Intelligence</CardTitle>
            </CardHeader>
